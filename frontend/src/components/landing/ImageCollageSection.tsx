...
const ImageCollageSection = () => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.set(card1, { x: -300, rotation: -15, scale: 0.7, transformOrigin: 'center center' });
      gsap.set(card2, { x: 300, rotation: 15, scale: 0.7, transformOrigin: 'center center' });
      gsap.set(card3, { x: -200, y: 150, rotation: -10, scale: 0.7, transformOrigin: 'center center' });
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-1 bg-gray-200 dark:bg-gray-700 z-50">
        <div ref={progressBarRef} className="h-full bg-gradient-to-r from-blue-500 to-purple-500 origin-left" />
      </div>
      ...
      <div ref={containerRef} className="relative z-10 h-full flex flex-col justify-start items-center px-8 md:px-16 lg:px-24 pt-8">
        ...
        <div className="text-center mb-8 mt-4">
          <h2 ref={titleRef} className="text-5xl md:text-7xl lg:text-8xl font-black mb-4 bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 dark:from-white dark:via-blue-200 dark:to-purple-200 bg-clip-text text-transparent leading-tight">
            Seamless Reading
            <br />
            <span className="text-4xl md:text-6xl lg:text-7xl">Experience</span>
          </h2>
          <p ref={subtitleRef} className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Discover how our AI transforms the way you interact with your documents
          </p>
        </div>

        {/* Decorative floating elements */}
        <div ref={decorativeRef1} className="absolute top-16 left-20 w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full opacity-60 will-change-transform" />
        <div ref={decorativeRef2} className="absolute top-24 right-32 w-12 h-12 bg-gradient-to-br from-purple-400 to-purple-600 rounded-lg opacity-60 will-change-transform" />
        <div ref={decorativeRef3} className="absolute bottom-20 left-40 w-10 h-10 bg-gradient-to-br from-pink-400 to-pink-600 rounded-full opacity-60 will-change-transform" />

        {/* Cards Grid */}
        <div className="relative w-full max-w-7xl mx-auto mt-2">
          <div ref={card1Ref} className="absolute top-8 left-1/2 transform -translate-x-1/2 w-80 h-[450px] md:w-88 md:h-[480px] group cursor-pointer z-10 will-change-transform">
            <div className="relative w-full h-full rounded-3xl overflow-hidden bg-white dark:bg-gray-800 shadow-2xl border border-gray-200 dark:border-gray-700 transform transition-all duration-500 group-hover:scale-105 group-hover:shadow-3xl">
              ...
              <img src="/images/Enhanced-reading.png" alt="Enhanced Reading" className="w-full h-3/5 object-cover transition-transform duration-500 group-hover:scale-110" loading="lazy" />
          ...
          <div ref={card2Ref} className="absolute top-4 right-4 w-88 h-[380px] md:w-96 md:h-[410px] group cursor-pointer z-20 will-change-transform">
            <div className="relative w-full h-full rounded-3xl overflow-hidden bg-white dark:bg-gray-800 shadow-2xl border border-gray-200 dark:border-gray-700 transform transition-all duration-500 group-hover:scale-105 group-hover:shadow-3xl">
              ...
              <img src="/images/Smart-dashboard.png" alt="Smart Dashboard" className="w-full h-3/5 object-cover transition-transform duration-500 group-hover:scale-110" loading="lazy" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent group-hover:from-black/70 transition-all duration-300"></div>
              <div className="absolute bottom-0 left-0 right-0 p-5">
                <div className="flex items-center mb-3">
          ...
          <div ref={card3Ref} className="absolute top-4 left-4 w-96 h-[320px] md:w-[420px] md:h-[350px] group cursor-pointer z-30 will-change-transform">
            <div className="relative w-full h-full rounded-3xl overflow-hidden bg-white dark:bg-gray-800 shadow-2xl border border-gray-200 dark:border-gray-700 transform transition-all duration-500 group-hover:scale-105 group-hover:shadow-3xl">
              ...
              <img src="/images/AI-powered.png" alt="AI-Powered Features" className="w-full h-3/5 object-cover transition-transform duration-500 group-hover:scale-110" loading="lazy" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent group-hover:from-black/70 transition-all duration-300"></div>
              <div className="absolute bottom-0 left-0 right-0 p-5">
                <div className="flex items-center mb-3">
        ...
        {/* Status indicator */}
        <div ref={statusRef} className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          <div className="inline-flex items-center space-x-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-md px-6 py-3 rounded-full shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Real-time AI Processing</span>
